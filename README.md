...
Brings the textbox style to be a lower-third black box

## Installation
1. Download the latest `no_bubble_textboxes.nrm` from Releases.
...
The produced mod file is named `no_bubble_textboxes.nrm`.
